...
\documentclass[12pt,doublespacing]{princeton_astro_thesis}
...
\title{Quantifying the Degree of Fine-tuning in Inflationary Potentials}
\author{Morgan Presley}
\adviser{Paul Steinhardt}
\date{May 2015}

\abstract{To be written later.}

\acknowledgments{I would like to acknowledge Mathematica's dedicated efforts at making my thesis as difficult to complete as possible.}

\dedication{I would like to dedicate my thesis to my family -- both in Illinois and here at Princeton -- for their support, without which I could not have finished this thesis.} 
...
\chapter{General Outline of Thesis}
\begin{itemize}
...
\section{How to describe an inflationary theory}
...
\section{History of Inflationary Theory}
\label{sec:History}
...
\chapter{Derivation of an Inflationary Theory}
\section{Inflationary Friedmann equation}
...
\section{Inflationary Field \& Equation of State}
...
\section{Calculating Observable Parameters}
...
\section{Fine-tuning in an Inflationary Theory}
...
\section{Slow Roll Approximation}
\label{sec:SlowRoll}
